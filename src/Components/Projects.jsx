      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-16 ">
        ...
        >
          ...
          <div>
            ...
            <h2 className="  md:text-lg mt-6">
              {' '}
              FinedBus Tour is a tour booking platform designed to streamline the process of discovering and booking travel packages. It provides users with a variety of filtering options, secure payments, and easy booking management.
            </h2>
            <h2 className=" font-semibold  md:text-lg mt-6"> Features:</h2>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <span className="font-semibold">User Authentication: </span>
                Secure login and registration via Google Firebase.
              </li>
              <li>
                <span className="font-semibold">Tour Listings: </span> Users can filter tours by location, price, and duration.
              </li>
              <li>
              ...
              <li>
                ...
                Allows tour operators to manage listings and bookings.
              </li>
            </ul>
            <h2 className=" font-semibold  md:text-lg mt-6">
              {' '}
              Used Technology:
            </h2>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <div className="flex items-center justify-between py-6">
            <Link
              target="_blank"
              href={'https://travel-tour-mu.vercel.app/dist/index.html'}
            ...
            <Link
              target="_blank"
              href={'https://github.com/nahidbinwadood/TravelTour'}
        ...
        >
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <span className="font-semibold">Wishlist and Offers: </span>
                Users can add properties to their wishlist and make offers.
              </li>
              <li>
                <span className="font-semibold">Property Sales: </span> Agents
                can sell properties to the highest bidder.
              </li>
              <li>
                <span className="font-semibold">Property Management: </span>{' '}
                Agents add and update properties; listings require admin
                approval.
              </li>
            </ul>
            <h2 className=" font-semibold  md:text-lg mt-6">
        ...
        >
          ...
          <div>
            ...
            <h2 className="  md:text-lg mt-6">
              {' '}
              VolunteerHub is a volunteer management system website allowing
              users to post, apply, manage, and track volunteer opportunities
              with Google account integration for easy access and interaction.
            </h2>
            <h2 className=" font-semibold  md:text-lg mt-6"> Features:</h2>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                ...
                Users can post their volunteer opportunities and hire volunteers
                for their projects.
              </li>
              <li>
                <span className="font-semibold">Apply for Opportunities: </span>{' '}
                Users can apply for various volunteer opportunities where they
                want to contribute.
              </li>
              <li>
                <span className="font-semibold">
                ...
                Features advanced filtering and search functionality on the
                volunteer page to easily find desired posts.
              </li>
            </ul>
            <h2 className=" font-semibold  md:text-lg mt-6">
              {' '}
        ...
        >
          ...
          <div>
            ...
            <h2 className="  md:text-lg mt-6">
              {' '}
              Developed Paint Home, a responsive, full-stack website for drawing
              and painting with various categories, extensive art information,
              and a platform for users to share their creations.
            </h2>
            <h2 className=" font-semibold  md:text-lg mt-6"> Features:</h2>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <span className="font-semibold">User Accounts: </span> Seamless
                account creation via Google login for full access..
              </li>
              <li>
                <span className="font-semibold">Post and Manage Art: </span>{' '}
                Users can post, update, and delete their painting information on
                the My Art & Craft List page.
              </li>
              <li>
                <span className="font-semibold">Data Security: </span> Ensures
                each users data is secure and private; users can only access and
